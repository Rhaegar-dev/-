'''
Задан корень двоичного дерева, напишите функцию serialize(root), которая сериализует дерево в строку, и deserialize(s), которая десериализует строку обратно в дерево.
'''
import json
